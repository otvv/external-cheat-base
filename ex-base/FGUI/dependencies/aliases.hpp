...
// library includes
#define FGUI_USE_D3D9 // tell FGUI to use another renderer
...
using pDrawGradient = std::add_pointer_t<void(int, int, int, int, const FGUI::COLOR&, const FGUI::COLOR&, bool)>;
