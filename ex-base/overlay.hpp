...
namespace OVERLAY
{
	...
	inline void Drawing()
	{
		...
		{
			// watermark
			RENDER::Text(10, 10, FONTS::Title, { 245, 245, 245 }, "[external base]");
	...
	inline void SetWindowToTarget() {
		...
		{
			PRINT("[external base] - window not found.");
		}
	...
	inline void OnEntryPoint(HINSTANCE _instance)
	{
		...
		m_strOverlayWindowName = "[external base] - Apex Legends";
		m_strTargetWindowName = "Apex Legends";
